...
function cargarAlojamiento(e){
    ...
    let inputCodigoConfirmacion = document.querySelector("#inputCodigoConfirmacion").value;
    let inputCantidadNoches = document.querySelector("#inputCantidadNoches").value;
    let inputCantidadHab = document.querySelector("#inputCantidadHab").value;
    let inputCantidadPersonas = document.querySelector("#inputCantidadPersonas").value;

    //verifica que los compos nombre, ciudad, fecha inicio y fecha fin esten completos
    if(nombre != "" && ciudad != "" && fechaInicio != "" && fechaFinalizacion != ""){
   ...
   let data = {
    ...
    let url = encodeURI("api/insertar_alojamiento");
...
document.addEventListener('DOMContentLoaded', function(){
    document.querySelector("#form_alta").addEventListener('submit', cargarAlojamiento); 
